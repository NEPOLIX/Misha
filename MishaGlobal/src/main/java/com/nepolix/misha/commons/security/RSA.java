...
package com.nepolix.misha.commons.security;
...
class RSA
{
	 ...
	 final static String PRIVATE_KEY = null;
	 
	 final static String PUBLIC_KEY = null;
	 ...
	 /**
		...
		*/
	 public static
	 RSAPrivateKey getPrivateKeyFromString ( String key )
					 throws
					 IOException,
	 ...
	 /**
		...
		*/
	 public static
	 RSAPublicKey getPublicKeyFromString ( String key )
					 throws
					 IOException,
					 GeneralSecurityException
	 {
			
			String publicKeyPEM = new String ( key );
					 ...
					 GeneralSecurityException
	 {
			...
			Cipher cipher = Cipher.getInstance ( "RSA" );
			cipher.init ( Cipher.ENCRYPT_MODE , getDefaultPublicKey ( ) );
			return Base64.toBase64 ( cipher.doFinal ( rawText.getBytes ( "UTF-8" ) ) );
	 }
					 ...
					 GeneralSecurityException
	 {
			...
			Cipher cipher = Cipher.getInstance ( "RSA" );
			cipher.init ( Cipher.DECRYPT_MODE , RSA.getDefaultPrivateKey ( ) );
			return new String ( cipher.doFinal ( Base64.decodeBase64 ( cipherText ) ) , "UTF-8" );
	 }
